...
export default defineConfig({
	resolve: {
		alias: [
			{ find: '@xuexitong-ai-helper/core/src', replacement: path.resolve(__dirname, '../core/src') },
			{ find: '@xuexitong-ai-helper/core', replacement: path.resolve(__dirname, '../core/src/index.ts') },
